...
public class RealestateApp {
     ...
     */
    public void addRealEstateToRegister() {
    ...
    private void findRealEstateByOwner() {
        ...
        if (owner.isBlank() || owner.isEmpty() ||properties.findAllPropertiesByOwner(owner).isEmpty()) {
            System.out.println("You have to enter a name. Name not found.");
        } else {
            System.out.println("Found these properties when searching for " + owner + ": ");
            for(Property property : properties.getProperties().values()) {
                if(property.getNameOfOwner().equalsIgnoreCase(owner)) {
                    displayProperty(property);
                }
            }
        }
    ...
    public void calculateAverageRealEstateArea() {
        ...
        {
            System.out.println("The average a rea of all the properties in the register is "
