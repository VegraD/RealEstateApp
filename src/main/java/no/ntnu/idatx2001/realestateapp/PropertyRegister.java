...
public class PropertyRegister {
     ...
     */
    public Set<Property> findAllPropertiesWithLotNumber(int lotNumber)
    {
     ...
     * @return a collection of properties found.
     */
    public Set<Property> findAllPropertiesByOwner(String nameOfOwner) {
        HashSet<Property> foundProperties = new HashSet<>();
        for (Property property : this.properties.values())
        {
